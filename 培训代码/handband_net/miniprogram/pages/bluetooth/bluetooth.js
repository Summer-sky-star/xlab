...
Page({
  ...
  Connect: function (e) {
    ...
    wx.createBLEConnection({
      ...
      success: function (res) {
        ...
        wx.redirectTo({
          //url: '/pages/send_three/send_three?connectedDeviceId=' + e.currentTarget.id + '&name=' + name
          url: '/pages/index/index?connectedDeviceId=' + e.currentTarget.id + '&name=' + name + '&userName=' + that.data.userName
        })
      },
      fail: function (res) {
        console.log(res)
  ...
  onLoad: function (options) {
    let that = this
    let list_height = ((app.globalData.SystemInfo.windowHeight - 50) * (750 / app.globalData.SystemInfo.windowWidth)) - 60
    that.setData({
    ...
    wx.onBluetoothDeviceFound(function (devices) {
      ...
      if (devices.deviceId) {
        ...
        if (isnotexist&&devices.devices[0].name.length != 0) {
