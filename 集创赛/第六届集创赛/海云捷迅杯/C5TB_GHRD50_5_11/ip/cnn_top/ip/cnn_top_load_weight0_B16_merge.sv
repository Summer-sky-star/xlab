...
// SystemVerilog created from cnn_top_load_weight0_B16_merge
...
module cnn_top_load_weight0_B16_merge (
    ...
    output wire [0:0] out_unnamed_load_weight047,
    output wire [0:0] out_unnamed_load_weight048,
    ...
    wire [0:0] unnamed_load_weight047_mux_s;
    reg [0:0] unnamed_load_weight047_mux_q;
    wire [0:0] unnamed_load_weight048_mux_s;
    reg [0:0] unnamed_load_weight048_mux_q;
    wire [0:0] valid_or_q;
    ...
    // unnamed_load_weight047_mux(MUX,96)
    assign unnamed_load_weight047_mux_s = in_valid_in_0;
    always @(unnamed_load_weight047_mux_s or in_unnamed_load_weight047_1 or in_unnamed_load_weight047_0)
    begin
        unique case (unnamed_load_weight047_mux_s)
            1'b0 : unnamed_load_weight047_mux_q = in_unnamed_load_weight047_1;
            1'b1 : unnamed_load_weight047_mux_q = in_unnamed_load_weight047_0;
            default : unnamed_load_weight047_mux_q = 1'b0;
        endcase
    end

    // out_unnamed_load_weight047(GPOUT,87)
    assign out_unnamed_load_weight047 = unnamed_load_weight047_mux_q;

    // unnamed_load_weight048_mux(MUX,97)
    assign unnamed_load_weight048_mux_s = in_valid_in_0;
    always @(unnamed_load_weight048_mux_s or in_unnamed_load_weight048_1 or in_unnamed_load_weight048_0)
    begin
        unique case (unnamed_load_weight048_mux_s)
            1'b0 : unnamed_load_weight048_mux_q = in_unnamed_load_weight048_1;
            1'b1 : unnamed_load_weight048_mux_q = in_unnamed_load_weight048_0;
            default : unnamed_load_weight048_mux_q = 1'b0;
        endcase
    end

    // out_unnamed_load_weight048(GPOUT,88)
    assign out_unnamed_load_weight048 = unnamed_load_weight048_mux_q;
