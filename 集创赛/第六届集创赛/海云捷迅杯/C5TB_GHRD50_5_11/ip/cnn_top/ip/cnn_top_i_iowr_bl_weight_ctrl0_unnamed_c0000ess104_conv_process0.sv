...
// SystemVerilog created from cnn_top_i_iowr_bl_weight_ctrl0_unnamed_c0000ess104_conv_process0
// SystemVerilog created on Fri Mar  4 14:17:40 2022


(* altera_attribute = "-name AUTO_SHIFT_REGISTER_RECOGNITION OFF; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 10037; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 15400; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 12020; -name MESSAGE_DISABLE 12030; -name MESSAGE_DISABLE 12010; -name MESSAGE_DISABLE 12110; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 13410; -name MESSAGE_DISABLE 113007; -name MESSAGE_DISABLE 10958" *)
module cnn_top_i_iowr_bl_weight_ctrl0_unnamed_c0000ess104_conv_process0 (
    output wire [0:0] out_iowr_bl_weight_ctrl0_1_o_fifovalid,
    output wire [0:0] out_o_ack,
    output wire [0:0] out_o_valid,
    input wire [0:0] in_cmp24489_phi_decision96_xor120,
    ...
    assign iowr_i_fifoready = in_iowr_bl_weight_ctrl0_1_i_fifoready;
    assign iowr_i_fifosize = dupName_0_const_0_x_q;
    assign iowr_i_packetempty = dupName_0_const_0_x_q;
    assign iowr_i_predicate = in_cmp24489_phi_decision96_xor120;
    ...
    assign out_iowr_bl_weight_ctrl0_1_o_fifovalid = iowr_o_fifovalid;
    ...
    assign out_iowr_bl_weight_ctrl0_1_o_fifodata = iowr_o_fifodata;
