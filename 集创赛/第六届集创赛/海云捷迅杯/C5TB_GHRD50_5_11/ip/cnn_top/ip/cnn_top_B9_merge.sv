...
module cnn_top_B9_merge (
    ...
    wire [0:0] i5_0119_mux_s;
    reg [31:0] i5_0119_mux_q;
    ...
    // i5_0119_mux(MUX,3)
    assign i5_0119_mux_s = in_valid_in_0;
    always @(i5_0119_mux_s or in_i5_0119_1 or in_i5_0119_0)
    begin
        unique case (i5_0119_mux_s)
            1'b0 : i5_0119_mux_q = in_i5_0119_1;
            1'b1 : i5_0119_mux_q = in_i5_0119_0;
            default : i5_0119_mux_q = 32'b0;
        endcase
    end

    // out_i5_0119(GPOUT,12)
    assign out_i5_0119 = i5_0119_mux_q;
