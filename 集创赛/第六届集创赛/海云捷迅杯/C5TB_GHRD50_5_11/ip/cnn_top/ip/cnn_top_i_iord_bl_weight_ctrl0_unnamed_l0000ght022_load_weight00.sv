...
// SystemVerilog created from cnn_top_i_iord_bl_weight_ctrl0_unnamed_l0000ght022_load_weight00
...
module cnn_top_i_iord_bl_weight_ctrl0_unnamed_l0000ght022_load_weight00 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_weight_ctrl0_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_weight_ctrl0_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_weight_ctrl0_i_fifodata),
    ...
    assign out_iord_bl_weight_ctrl0_o_fifoready = iord_o_fifoready;

    // regfree_osync(GPOUT,13)
    assign out_iord_bl_weight_ctrl0_o_fifoalmost_full = iord_o_fifoalmost_full;
