...
// SystemVerilog created from cnn_top_load_weight0_B14_merge
...
module cnn_top_load_weight0_B14_merge (
    ...
    output wire [0:0] out_unnamed_load_weight044,
    output wire [0:0] out_unnamed_load_weight045,
    ...
    wire [0:0] unnamed_load_weight044_mux_s;
    reg [0:0] unnamed_load_weight044_mux_q;
    wire [0:0] unnamed_load_weight045_mux_s;
    reg [0:0] unnamed_load_weight045_mux_q;
    wire [0:0] valid_or_q;
    ...
    // unnamed_load_weight044_mux(MUX,64)
    assign unnamed_load_weight044_mux_s = in_valid_in_0;
    always @(unnamed_load_weight044_mux_s or in_unnamed_load_weight044_1 or in_unnamed_load_weight044_0)
    begin
        unique case (unnamed_load_weight044_mux_s)
            1'b0 : unnamed_load_weight044_mux_q = in_unnamed_load_weight044_1;
            1'b1 : unnamed_load_weight044_mux_q = in_unnamed_load_weight044_0;
            default : unnamed_load_weight044_mux_q = 1'b0;
        endcase
    end

    // out_unnamed_load_weight044(GPOUT,57)
    assign out_unnamed_load_weight044 = unnamed_load_weight044_mux_q;

    // unnamed_load_weight045_mux(MUX,65)
    assign unnamed_load_weight045_mux_s = in_valid_in_0;
    always @(unnamed_load_weight045_mux_s or in_unnamed_load_weight045_1 or in_unnamed_load_weight045_0)
    begin
        unique case (unnamed_load_weight045_mux_s)
            1'b0 : unnamed_load_weight045_mux_q = in_unnamed_load_weight045_1;
            1'b1 : unnamed_load_weight045_mux_q = in_unnamed_load_weight045_0;
            default : unnamed_load_weight045_mux_q = 1'b0;
        endcase
    end

    // out_unnamed_load_weight045(GPOUT,58)
    assign out_unnamed_load_weight045 = unnamed_load_weight045_mux_q;
