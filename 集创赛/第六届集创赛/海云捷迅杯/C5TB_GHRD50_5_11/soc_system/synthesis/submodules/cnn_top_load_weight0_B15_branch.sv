...
// SystemVerilog created from cnn_top_load_weight0_B15_branch
...
module cnn_top_load_weight0_B15_branch (
    ...
    wire [0:0] load_weight0_B15_branch_enable_q;
    wire [0:0] load_weight0_B15_branch_enable_not_q;
    ...
    begin
        ...
        else if (load_weight0_B15_branch_enable_q == 1'b1)
        begin
    ...
    // load_weight0_B15_branch_enable(LOGICAL,11)
    assign load_weight0_B15_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;
    ...
    // load_weight0_B15_branch_enable_not(LOGICAL,12)
    assign load_weight0_B15_branch_enable_not_q = ~ (load_weight0_B15_branch_enable_q);

    // out_stall_out(GPOUT,21)
    assign out_stall_out = load_weight0_B15_branch_enable_not_q;
