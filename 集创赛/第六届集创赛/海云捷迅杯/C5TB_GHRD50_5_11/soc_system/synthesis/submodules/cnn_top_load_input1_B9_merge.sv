...
module cnn_top_load_input1_B9_merge (
    ...
    wire [0:0] li_082_mux_s;
    reg [31:0] li_082_mux_q;
    ...
    // li_082_mux(MUX,10)
    assign li_082_mux_s = in_valid_in_0;
    always @(li_082_mux_s or in_li_082_1 or in_li_082_0)
    begin
        unique case (li_082_mux_s)
            1'b0 : li_082_mux_q = in_li_082_1;
            1'b1 : li_082_mux_q = in_li_082_0;
            default : li_082_mux_q = 32'b0;
        endcase
    end

    // out_li_082(GPOUT,12)
    assign out_li_082 = li_082_mux_q;
