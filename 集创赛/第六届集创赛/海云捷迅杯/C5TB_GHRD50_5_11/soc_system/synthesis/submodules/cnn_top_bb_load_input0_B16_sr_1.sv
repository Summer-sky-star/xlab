...
module cnn_top_bb_load_input0_B16_sr_1 (
    ...
    // combined_valid(LOGICAL,90)
    assign combined_valid_q = in_i_valid | sr_valid_q;

    // stall_and_valid(LOGICAL,93)
