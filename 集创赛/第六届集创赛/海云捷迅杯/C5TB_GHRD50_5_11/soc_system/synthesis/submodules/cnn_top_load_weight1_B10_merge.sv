...
// SystemVerilog created from cnn_top_load_weight1_B10_merge
...
module cnn_top_load_weight1_B10_merge (
    ...
    output wire [0:0] out_unnamed_load_weight137,
    ...
    wire [0:0] unnamed_load_weight137_mux_s;
    reg [0:0] unnamed_load_weight137_mux_q;
    wire [0:0] valid_or_q;
    ...
    // unnamed_load_weight137_mux(MUX,21)
    assign unnamed_load_weight137_mux_s = in_valid_in_0;
    always @(unnamed_load_weight137_mux_s or in_unnamed_load_weight137_1 or in_unnamed_load_weight137_0)
    begin
        unique case (unnamed_load_weight137_mux_s)
            1'b0 : unnamed_load_weight137_mux_q = in_unnamed_load_weight137_1;
            1'b1 : unnamed_load_weight137_mux_q = in_unnamed_load_weight137_0;
            default : unnamed_load_weight137_mux_q = 1'b0;
        endcase
    end

    // out_unnamed_load_weight137(GPOUT,17)
    assign out_unnamed_load_weight137 = unnamed_load_weight137_mux_q;
