...
// SystemVerilog created from cnn_top_flt_i_sfc_logic_s_c0_in_for_cond000016oe0cp36cd0oq3cdj6z
// SystemVerilog created on Fri Mar  4 14:17:40 2022


(* altera_attribute = "-name AUTO_SHIFT_REGISTER_RECOGNITION OFF; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 10037; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 15400; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 12020; -name MESSAGE_DISABLE 12030; -name MESSAGE_DISABLE 12010; -name MESSAGE_DISABLE 12110; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 13410; -name MESSAGE_DISABLE 113007; -name MESSAGE_DISABLE 10958" *)
module cnn_top_flt_i_sfc_logic_s_c0_in_for_cond000016oe0cp36cd0oq3cdj6z (
    ...
    wire [0:0] sticky_uid20_block_rsrvd_fix_q;
    ...
    wire [0:0] vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q;
    ...
    reg [5:0] redist2_vCount_uid82_lzcShifterZ1_uid10_block_rsrvd_fix_q_1_q;
    reg [0:0] redist3_vCount_uid63_lzcShifterZ1_uid10_block_rsrvd_fix_q_1_q;
    reg [0:0] redist4_vCount_uid56_lzcShifterZ1_uid10_block_rsrvd_fix_q_2_q;
    reg [0:0] redist4_vCount_uid56_lzcShifterZ1_uid10_block_rsrvd_fix_q_2_delay_0;
    reg [0:0] redist5_vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix_q_3_q;
    reg [0:0] redist5_vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix_q_3_delay_0;
    reg [0:0] redist5_vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix_q_3_delay_1;
    reg [0:0] redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_q;
    reg [0:0] redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_delay_0;
    reg [0:0] redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_delay_1;
    reg [0:0] redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_delay_2;
    reg [7:0] redist7_expR_uid38_block_rsrvd_fix_b_1_q;
    reg [9:0] redist8_expR_uid26_block_rsrvd_fix_b_1_q;
    reg [22:0] redist9_fracR_uid25_block_rsrvd_fix_b_2_q;
    reg [22:0] redist9_fracR_uid25_block_rsrvd_fix_b_2_delay_0;
    reg [32:0] redist10_expFracRnd_uid16_block_rsrvd_fix_q_1_q;
    reg [0:0] redist11_inIsZero_uid12_block_rsrvd_fix_q_3_q;
    reg [0:0] redist11_inIsZero_uid12_block_rsrvd_fix_q_3_delay_0;
    reg [31:0] redist12_y_uid9_block_rsrvd_fix_b_1_q;
    reg [0:0] redist13_signX_uid6_block_rsrvd_fix_b_9_q;
    ...
    // redist13_signX_uid6_block_rsrvd_fix_b_9(DELAY,108)
    dspba_delay_ver #( .width(1), .depth(9), .reset_kind("ASYNC"), .phase(0), .modulus(1), .reset_high(1'b0) )
    redist13_signX_uid6_block_rsrvd_fix_b_9 ( .xin(signX_uid6_block_rsrvd_fix_b), .xout(redist13_signX_uid6_block_rsrvd_fix_b_9_q), .clk(clock), .aclr(resetn), .ena(1'b1) );
    ...
    // rVStage_uid76_lzcShifterZ1_uid10_block_rsrvd_fix_merged_bit_select(BITSELECT,93)@5
    ...
    // cStage_uid80_lzcShifterZ1_uid10_block_rsrvd_fix(BITJOIN,79)@5
    ...
    // rVStage_uid69_lzcShifterZ1_uid10_block_rsrvd_fix_merged_bit_select(BITSELECT,92)@5
    ...
    // cStage_uid73_lzcShifterZ1_uid10_block_rsrvd_fix(BITJOIN,72)@5
    ...
    // rVStage_uid62_lzcShifterZ1_uid10_block_rsrvd_fix_merged_bit_select(BITSELECT,91)@4
    ...
    // cStage_uid66_lzcShifterZ1_uid10_block_rsrvd_fix(BITJOIN,65)@4
    ...
    // rVStage_uid55_lzcShifterZ1_uid10_block_rsrvd_fix_merged_bit_select(BITSELECT,90)@3
    ...
    // cStage_uid59_lzcShifterZ1_uid10_block_rsrvd_fix(BITJOIN,58)@3
    ...
    // rVStage_uid48_lzcShifterZ1_uid10_block_rsrvd_fix_merged_bit_select(BITSELECT,89)@2
    ...
    // cStage_uid52_lzcShifterZ1_uid10_block_rsrvd_fix(BITJOIN,51)@2
    ...
    // redist12_y_uid9_block_rsrvd_fix_b_1(DELAY,107)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist12_y_uid9_block_rsrvd_fix_b_1_q <= '0;
        end
        else
        begin
            redist12_y_uid9_block_rsrvd_fix_b_1_q <= $unsigned(y_uid9_block_rsrvd_fix_b);
        end
    end

    // vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix(LOGICAL,43)@1
    assign vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q = $unsigned(redist12_y_uid9_block_rsrvd_fix_b_1_q == zs_uid42_lzcShifterZ1_uid10_block_rsrvd_fix_q ? 1'b1 : 1'b0);

    // vStagei_uid46_lzcShifterZ1_uid10_block_rsrvd_fix(MUX,45)@1 + 1
    ...
    begin
        ...
        begin
            unique case (vStagei_uid46_lzcShifterZ1_uid10_block_rsrvd_fix_s)
                1'b0 : vStagei_uid46_lzcShifterZ1_uid10_block_rsrvd_fix_q <= redist12_y_uid9_block_rsrvd_fix_b_1_q;
    ...
    // vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix(LOGICAL,48)@2
    ...
    // vStagei_uid53_lzcShifterZ1_uid10_block_rsrvd_fix(MUX,52)@2 + 1
    ...
    // vCount_uid56_lzcShifterZ1_uid10_block_rsrvd_fix(LOGICAL,55)@3
    ...
    // vStagei_uid60_lzcShifterZ1_uid10_block_rsrvd_fix(MUX,59)@3 + 1
    ...
    // vCount_uid63_lzcShifterZ1_uid10_block_rsrvd_fix(LOGICAL,62)@4
    ...
    // vStagei_uid67_lzcShifterZ1_uid10_block_rsrvd_fix(MUX,66)@4 + 1
    ...
    // vCount_uid70_lzcShifterZ1_uid10_block_rsrvd_fix(LOGICAL,69)@5
    ...
    // vStagei_uid74_lzcShifterZ1_uid10_block_rsrvd_fix(MUX,73)@5
    ...
    // vCount_uid77_lzcShifterZ1_uid10_block_rsrvd_fix(LOGICAL,76)@5
    ...
    // vStagei_uid81_lzcShifterZ1_uid10_block_rsrvd_fix(MUX,80)@5
    ...
    // fracRnd_uid15_block_rsrvd_fix_merged_bit_select(BITSELECT,94)@5
    ...
    // sticky_uid20_block_rsrvd_fix(LOGICAL,19)@6
    assign sticky_uid20_block_rsrvd_fix_q = $unsigned(redist1_fracRnd_uid15_block_rsrvd_fix_merged_bit_select_c_1_q != 7'b0000000 ? 1'b1 : 1'b0);

    // nr_uid21_block_rsrvd_fix(LOGICAL,20)@6
    ...
    // redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4(DELAY,101)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_delay_0 <= '0;
            redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_delay_1 <= '0;
            redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_delay_2 <= '0;
            redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_q <= '0;
        end
        else
        begin
            redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_delay_0 <= $unsigned(vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q);
            redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_delay_1 <= redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_delay_0;
            redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_delay_2 <= redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_delay_1;
            redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_q <= redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_delay_2;
        end
    end

    // redist5_vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix_q_3(DELAY,100)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist5_vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix_q_3_delay_0 <= '0;
            redist5_vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix_q_3_delay_1 <= '0;
            redist5_vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix_q_3_q <= '0;
        end
        else
        begin
            redist5_vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix_q_3_delay_0 <= $unsigned(vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix_q);
            redist5_vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix_q_3_delay_1 <= redist5_vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix_q_3_delay_0;
            redist5_vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix_q_3_q <= redist5_vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix_q_3_delay_1;
        end
    end

    // redist4_vCount_uid56_lzcShifterZ1_uid10_block_rsrvd_fix_q_2(DELAY,99)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist4_vCount_uid56_lzcShifterZ1_uid10_block_rsrvd_fix_q_2_delay_0 <= '0;
            redist4_vCount_uid56_lzcShifterZ1_uid10_block_rsrvd_fix_q_2_q <= '0;
        end
        else
        begin
            redist4_vCount_uid56_lzcShifterZ1_uid10_block_rsrvd_fix_q_2_delay_0 <= $unsigned(vCount_uid56_lzcShifterZ1_uid10_block_rsrvd_fix_q);
            redist4_vCount_uid56_lzcShifterZ1_uid10_block_rsrvd_fix_q_2_q <= redist4_vCount_uid56_lzcShifterZ1_uid10_block_rsrvd_fix_q_2_delay_0;
        end
    end

    // redist3_vCount_uid63_lzcShifterZ1_uid10_block_rsrvd_fix_q_1(DELAY,98)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist3_vCount_uid63_lzcShifterZ1_uid10_block_rsrvd_fix_q_1_q <= '0;
        end
        else
        begin
            redist3_vCount_uid63_lzcShifterZ1_uid10_block_rsrvd_fix_q_1_q <= $unsigned(vCount_uid63_lzcShifterZ1_uid10_block_rsrvd_fix_q);
        end
    end

    // vCount_uid82_lzcShifterZ1_uid10_block_rsrvd_fix(BITJOIN,81)@5
    assign vCount_uid82_lzcShifterZ1_uid10_block_rsrvd_fix_q = {redist6_vCount_uid44_lzcShifterZ1_uid10_block_rsrvd_fix_q_4_q, redist5_vCount_uid49_lzcShifterZ1_uid10_block_rsrvd_fix_q_3_q, redist4_vCount_uid56_lzcShifterZ1_uid10_block_rsrvd_fix_q_2_q, redist3_vCount_uid63_lzcShifterZ1_uid10_block_rsrvd_fix_q_1_q, vCount_uid70_lzcShifterZ1_uid10_block_rsrvd_fix_q, vCount_uid77_lzcShifterZ1_uid10_block_rsrvd_fix_q};

    // redist2_vCount_uid82_lzcShifterZ1_uid10_block_rsrvd_fix_q_1(DELAY,97)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist2_vCount_uid82_lzcShifterZ1_uid10_block_rsrvd_fix_q_1_q <= '0;
        end
        else
        begin
            redist2_vCount_uid82_lzcShifterZ1_uid10_block_rsrvd_fix_q_1_q <= $unsigned(vCount_uid82_lzcShifterZ1_uid10_block_rsrvd_fix_q);
        end
    end

    // vCountBig_uid84_lzcShifterZ1_uid10_block_rsrvd_fix(COMPARE,83)@5 + 1
    ...
    // vCountFinal_uid86_lzcShifterZ1_uid10_block_rsrvd_fix(MUX,85)@6
    assign vCountFinal_uid86_lzcShifterZ1_uid10_block_rsrvd_fix_s = vCountBig_uid84_lzcShifterZ1_uid10_block_rsrvd_fix_c;
    always @(vCountFinal_uid86_lzcShifterZ1_uid10_block_rsrvd_fix_s or redist2_vCount_uid82_lzcShifterZ1_uid10_block_rsrvd_fix_q_1_q or maxCount_uid11_block_rsrvd_fix_q)
    begin
        unique case (vCountFinal_uid86_lzcShifterZ1_uid10_block_rsrvd_fix_s)
            1'b0 : vCountFinal_uid86_lzcShifterZ1_uid10_block_rsrvd_fix_q = redist2_vCount_uid82_lzcShifterZ1_uid10_block_rsrvd_fix_q_1_q;
    ...
    // expPreRnd_uid14_block_rsrvd_fix(SUB,13)@6
    ...
    // expFracRnd_uid16_block_rsrvd_fix(BITJOIN,15)@6
    ...
    // l_uid17_block_rsrvd_fix_merged_bit_select(BITSELECT,88)@6
    ...
    // rnd_uid22_block_rsrvd_fix(LOGICAL,21)@6 + 1
    ...
    // redist10_expFracRnd_uid16_block_rsrvd_fix_q_1(DELAY,105)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist10_expFracRnd_uid16_block_rsrvd_fix_q_1_q <= '0;
        end
        else
        begin
            redist10_expFracRnd_uid16_block_rsrvd_fix_q_1_q <= $unsigned(expFracRnd_uid16_block_rsrvd_fix_q);
        end
    end

    // expFracR_uid24_block_rsrvd_fix(ADD,23)@7
    assign expFracR_uid24_block_rsrvd_fix_a = $unsigned({{2{redist10_expFracRnd_uid16_block_rsrvd_fix_q_1_q[32]}}, redist10_expFracRnd_uid16_block_rsrvd_fix_q_1_q});
    ...
    // expR_uid26_block_rsrvd_fix(BITSELECT,25)@7
    assign expR_uid26_block_rsrvd_fix_b = $unsigned(expFracR_uid24_block_rsrvd_fix_q[33:24]);

    // redist8_expR_uid26_block_rsrvd_fix_b_1(DELAY,103)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist8_expR_uid26_block_rsrvd_fix_b_1_q <= '0;
        end
        else
        begin
            redist8_expR_uid26_block_rsrvd_fix_b_1_q <= $unsigned(expR_uid26_block_rsrvd_fix_b);
        end
    end

    // expR_uid38_block_rsrvd_fix(BITSELECT,37)@8
    assign expR_uid38_block_rsrvd_fix_in = redist8_expR_uid26_block_rsrvd_fix_b_1_q[7:0];
    assign expR_uid38_block_rsrvd_fix_b = expR_uid38_block_rsrvd_fix_in[7:0];

    // redist7_expR_uid38_block_rsrvd_fix_b_1(DELAY,102)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist7_expR_uid38_block_rsrvd_fix_b_1_q <= '0;
        end
        else
        begin
            redist7_expR_uid38_block_rsrvd_fix_b_1_q <= $unsigned(expR_uid38_block_rsrvd_fix_b);
        end
    end

    // ovf_uid29_block_rsrvd_fix(COMPARE,28)@8 + 1
    assign ovf_uid29_block_rsrvd_fix_a = $unsigned({{2{redist8_expR_uid26_block_rsrvd_fix_b_1_q[9]}}, redist8_expR_uid26_block_rsrvd_fix_b_1_q});
    ...
    // inIsZero_uid12_block_rsrvd_fix(LOGICAL,11)@6 + 1
    ...
    // redist11_inIsZero_uid12_block_rsrvd_fix_q_3(DELAY,106)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist11_inIsZero_uid12_block_rsrvd_fix_q_3_delay_0 <= '0;
            redist11_inIsZero_uid12_block_rsrvd_fix_q_3_q <= '0;
        end
        else
        begin
            redist11_inIsZero_uid12_block_rsrvd_fix_q_3_delay_0 <= $unsigned(inIsZero_uid12_block_rsrvd_fix_q);
            redist11_inIsZero_uid12_block_rsrvd_fix_q_3_q <= redist11_inIsZero_uid12_block_rsrvd_fix_q_3_delay_0;
        end
    end

    // udf_uid27_block_rsrvd_fix(COMPARE,26)@8 + 1
    assign udf_uid27_block_rsrvd_fix_a = $unsigned({11'b00000000000, GND_q});
    assign udf_uid27_block_rsrvd_fix_b = $unsigned({{2{redist8_expR_uid26_block_rsrvd_fix_b_1_q[9]}}, redist8_expR_uid26_block_rsrvd_fix_b_1_q});
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // udfOrInZero_uid33_block_rsrvd_fix(LOGICAL,32)@9
    assign udfOrInZero_uid33_block_rsrvd_fix_q = udf_uid27_block_rsrvd_fix_n | redist11_inIsZero_uid12_block_rsrvd_fix_q_3_q;

    // excSelector_uid34_block_rsrvd_fix(BITJOIN,33)@9
    assign excSelector_uid34_block_rsrvd_fix_q = {ovf_uid29_block_rsrvd_fix_n, udfOrInZero_uid33_block_rsrvd_fix_q};

    // expRPostExc_uid39_block_rsrvd_fix(MUX,38)@9
    assign expRPostExc_uid39_block_rsrvd_fix_s = excSelector_uid34_block_rsrvd_fix_q;
    always @(expRPostExc_uid39_block_rsrvd_fix_s or redist7_expR_uid38_block_rsrvd_fix_b_1_q or expZ_uid37_block_rsrvd_fix_q or expInf_uid28_block_rsrvd_fix_q)
    begin
        unique case (expRPostExc_uid39_block_rsrvd_fix_s)
            2'b00 : expRPostExc_uid39_block_rsrvd_fix_q = redist7_expR_uid38_block_rsrvd_fix_b_1_q;
    ...
    // fracR_uid25_block_rsrvd_fix(BITSELECT,24)@7
    ...
    // redist9_fracR_uid25_block_rsrvd_fix_b_2(DELAY,104)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist9_fracR_uid25_block_rsrvd_fix_b_2_delay_0 <= '0;
            redist9_fracR_uid25_block_rsrvd_fix_b_2_q <= '0;
        end
        else
        begin
            redist9_fracR_uid25_block_rsrvd_fix_b_2_delay_0 <= $unsigned(fracR_uid25_block_rsrvd_fix_b);
            redist9_fracR_uid25_block_rsrvd_fix_b_2_q <= redist9_fracR_uid25_block_rsrvd_fix_b_2_delay_0;
        end
    end

    // excSelector_uid30_block_rsrvd_fix(LOGICAL,29)@9
    assign excSelector_uid30_block_rsrvd_fix_q = redist11_inIsZero_uid12_block_rsrvd_fix_q_3_q | ovf_uid29_block_rsrvd_fix_n | udf_uid27_block_rsrvd_fix_n;

    // fracRPostExc_uid32_block_rsrvd_fix(MUX,31)@9
    assign fracRPostExc_uid32_block_rsrvd_fix_s = excSelector_uid30_block_rsrvd_fix_q;
    always @(fracRPostExc_uid32_block_rsrvd_fix_s or redist9_fracR_uid25_block_rsrvd_fix_b_2_q or fracZ_uid31_block_rsrvd_fix_q)
    begin
        unique case (fracRPostExc_uid32_block_rsrvd_fix_s)
            1'b0 : fracRPostExc_uid32_block_rsrvd_fix_q = redist9_fracR_uid25_block_rsrvd_fix_b_2_q;
    ...
    // outRes_uid40_block_rsrvd_fix(BITJOIN,39)@9
    assign outRes_uid40_block_rsrvd_fix_q = {redist13_signX_uid6_block_rsrvd_fix_b_9_q, expRPostExc_uid39_block_rsrvd_fix_q, fracRPostExc_uid32_block_rsrvd_fix_q};
