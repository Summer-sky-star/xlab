...
// SystemVerilog created from cnn_top_i_iord_bl_call_load_weight1_unna0000ight10_load_weight10
...
module cnn_top_i_iord_bl_call_load_weight1_unna0000ight10_load_weight10 (
    ...
    // iord(EXTIFACE,7)
    assign iord_i_fifodata = in_iord_bl_call_load_weight1_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_load_weight1_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_load_weight1_i_fifodata),
    ...
    assign out_iord_bl_call_load_weight1_o_fifoready = iord_o_fifoready;

    // regfree_osync(GPOUT,51)
    assign out_iord_bl_call_load_weight1_o_fifoalmost_full = iord_o_fifoalmost_full;
