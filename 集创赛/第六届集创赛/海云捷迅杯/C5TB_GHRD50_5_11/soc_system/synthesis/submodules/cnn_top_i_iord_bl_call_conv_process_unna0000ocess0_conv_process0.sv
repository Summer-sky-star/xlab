...
// SystemVerilog created from cnn_top_i_iord_bl_call_conv_process_unna0000ocess0_conv_process0
// SystemVerilog created on Fri Mar  4 14:17:40 2022


(* altera_attribute = "-name AUTO_SHIFT_REGISTER_RECOGNITION OFF; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 10037; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 15400; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 12020; -name MESSAGE_DISABLE 12030; -name MESSAGE_DISABLE 12010; -name MESSAGE_DISABLE 12110; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 13410; -name MESSAGE_DISABLE 113007; -name MESSAGE_DISABLE 10958" *)
module cnn_top_i_iord_bl_call_conv_process_unna0000ocess0_conv_process0 (
    ...
    wire [511:0] ip_dsdk_adapt_bitselect14_b;
    ...
    // iord(EXTIFACE,7)
    assign iord_i_fifodata = in_iord_bl_call_conv_process_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_conv_process_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_conv_process_i_fifodata),
    ...
    assign ip_dsdk_adapt_bitselect48_b = iord_o_data[831:768];

    // ip_dsdk_adapt_bitselect52(BITSELECT,31)
    assign ip_dsdk_adapt_bitselect52_b = ip_dsdk_adapt_bitselect48_b[63:32];

    // ip_dsdk_adapt_bitselect50(BITSELECT,30)
    assign ip_dsdk_adapt_bitselect50_b = ip_dsdk_adapt_bitselect48_b[31:0];

    // ip_dsdk_adapt_bitselect14(BITSELECT,10)
    assign ip_dsdk_adapt_bitselect14_b = iord_o_data[767:256];

    // ip_dsdk_adapt_bitselect46(BITSELECT,28)
    assign ip_dsdk_adapt_bitselect46_b = ip_dsdk_adapt_bitselect14_b[511:480];

    // ip_dsdk_adapt_bitselect44(BITSELECT,27)
    assign ip_dsdk_adapt_bitselect44_b = ip_dsdk_adapt_bitselect14_b[479:448];

    // ip_dsdk_adapt_bitselect42(BITSELECT,26)
    assign ip_dsdk_adapt_bitselect42_b = ip_dsdk_adapt_bitselect14_b[447:416];

    // ip_dsdk_adapt_bitselect40(BITSELECT,25)
    assign ip_dsdk_adapt_bitselect40_b = ip_dsdk_adapt_bitselect14_b[415:384];

    // ip_dsdk_adapt_bitselect38(BITSELECT,23)
    assign ip_dsdk_adapt_bitselect38_b = ip_dsdk_adapt_bitselect14_b[383:352];

    // ip_dsdk_adapt_bitselect36(BITSELECT,22)
    assign ip_dsdk_adapt_bitselect36_b = ip_dsdk_adapt_bitselect14_b[351:320];

    // ip_dsdk_adapt_bitselect34(BITSELECT,21)
    assign ip_dsdk_adapt_bitselect34_b = ip_dsdk_adapt_bitselect14_b[319:288];

    // ip_dsdk_adapt_bitselect32(BITSELECT,20)
    assign ip_dsdk_adapt_bitselect32_b = ip_dsdk_adapt_bitselect14_b[287:256];

    // ip_dsdk_adapt_bitselect30(BITSELECT,19)
    assign ip_dsdk_adapt_bitselect30_b = ip_dsdk_adapt_bitselect14_b[255:224];

    // ip_dsdk_adapt_bitselect28(BITSELECT,18)
    assign ip_dsdk_adapt_bitselect28_b = ip_dsdk_adapt_bitselect14_b[223:192];

    // ip_dsdk_adapt_bitselect26(BITSELECT,17)
    assign ip_dsdk_adapt_bitselect26_b = ip_dsdk_adapt_bitselect14_b[191:160];

    // ip_dsdk_adapt_bitselect24(BITSELECT,16)
    assign ip_dsdk_adapt_bitselect24_b = ip_dsdk_adapt_bitselect14_b[159:128];
    ...
    assign ip_dsdk_adapt_bitselect12_b = iord_o_data[255:224];

    // ip_dsdk_adapt_bitselect10(BITSELECT,8)
    assign ip_dsdk_adapt_bitselect10_b = iord_o_data[223:192];

    // ip_dsdk_adapt_bitselect8(BITSELECT,33)
    assign ip_dsdk_adapt_bitselect8_b = iord_o_data[191:160];

    // ip_dsdk_adapt_bitselect6(BITSELECT,32)
    ...
    assign out_o_data_21_tpl = ip_dsdk_adapt_bitselect46_b;
    ...
    assign out_iord_bl_call_conv_process_o_fifoready = iord_o_fifoready;

    // regfree_osync(GPOUT,60)
    assign out_iord_bl_call_conv_process_o_fifoalmost_full = iord_o_fifoalmost_full;
