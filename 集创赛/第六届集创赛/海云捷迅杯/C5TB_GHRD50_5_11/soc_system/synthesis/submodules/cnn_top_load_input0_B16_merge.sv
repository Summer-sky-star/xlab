...
module cnn_top_load_input0_B16_merge (
    ...
    output wire [31:0] out_add77166,
    output wire [0:0] out_forked65,
    output wire [31:0] out_kh_071_pop21107_pop37164,
    output wire [31:0] out_kh_071_pop21108_pop43171,
    output wire [31:0] out_kh_071_pop21135,
    output wire [31:0] out_kw_068_pop33112_pop45165,
    output wire [31:0] out_kw_068_pop33152,
    output wire [31:0] out_li_073100_pop40168,
    output wire [31:0] out_li_073124,
    output wire [31:0] out_li_07398_pop22140,
    output wire [31:0] out_li_07399_pop34155,
    ...
    output wire [0:0] out_unnamed_load_input051,
    ...
    wire [0:0] VCC_q;
    wire [0:0] add77166_mux_s;
    reg [31:0] add77166_mux_q;
    wire [0:0] forked65_mux_s;
    reg [0:0] forked65_mux_q;
    wire [0:0] kh_071_pop21107_pop37164_mux_s;
    reg [31:0] kh_071_pop21107_pop37164_mux_q;
    wire [0:0] kh_071_pop21108_pop43171_mux_s;
    reg [31:0] kh_071_pop21108_pop43171_mux_q;
    wire [0:0] kh_071_pop21135_mux_s;
    reg [31:0] kh_071_pop21135_mux_q;
    wire [0:0] kw_068_pop33112_pop45165_mux_s;
    reg [31:0] kw_068_pop33112_pop45165_mux_q;
    wire [0:0] kw_068_pop33152_mux_s;
    reg [31:0] kw_068_pop33152_mux_q;
    wire [0:0] li_073100_pop40168_mux_s;
    reg [31:0] li_073100_pop40168_mux_q;
    wire [0:0] li_073124_mux_s;
    reg [31:0] li_073124_mux_q;
    wire [0:0] li_07398_pop22140_mux_s;
    reg [31:0] li_07398_pop22140_mux_q;
    wire [0:0] li_07399_pop34155_mux_s;
    reg [31:0] li_07399_pop34155_mux_q;
    ...
    wire [0:0] unnamed_load_input051_mux_s;
    reg [0:0] unnamed_load_input051_mux_q;
    wire [0:0] valid_or_q;
    ...
    // add77166_mux(MUX,2)
    assign add77166_mux_s = in_valid_in_0;
    always @(add77166_mux_s or in_add77166_1 or in_add77166_0)
    begin
        unique case (add77166_mux_s)
            1'b0 : add77166_mux_q = in_add77166_1;
            1'b1 : add77166_mux_q = in_add77166_0;
            default : add77166_mux_q = 32'b0;
        endcase
    end

    // out_add77166(GPOUT,64)
    assign out_add77166 = add77166_mux_q;
    ...
    // kh_071_pop21107_pop37164_mux(MUX,49)
    assign kh_071_pop21107_pop37164_mux_s = in_valid_in_0;
    always @(kh_071_pop21107_pop37164_mux_s or in_kh_071_pop21107_pop37164_1 or in_kh_071_pop21107_pop37164_0)
    begin
        unique case (kh_071_pop21107_pop37164_mux_s)
            1'b0 : kh_071_pop21107_pop37164_mux_q = in_kh_071_pop21107_pop37164_1;
            1'b1 : kh_071_pop21107_pop37164_mux_q = in_kh_071_pop21107_pop37164_0;
            default : kh_071_pop21107_pop37164_mux_q = 32'b0;
        endcase
    end

    // out_kh_071_pop21107_pop37164(GPOUT,66)
    assign out_kh_071_pop21107_pop37164 = kh_071_pop21107_pop37164_mux_q;

    // kh_071_pop21108_pop43171_mux(MUX,50)
    assign kh_071_pop21108_pop43171_mux_s = in_valid_in_0;
    always @(kh_071_pop21108_pop43171_mux_s or in_kh_071_pop21108_pop43171_1 or in_kh_071_pop21108_pop43171_0)
    begin
        unique case (kh_071_pop21108_pop43171_mux_s)
            1'b0 : kh_071_pop21108_pop43171_mux_q = in_kh_071_pop21108_pop43171_1;
            1'b1 : kh_071_pop21108_pop43171_mux_q = in_kh_071_pop21108_pop43171_0;
            default : kh_071_pop21108_pop43171_mux_q = 32'b0;
        endcase
    end

    // out_kh_071_pop21108_pop43171(GPOUT,67)
    assign out_kh_071_pop21108_pop43171 = kh_071_pop21108_pop43171_mux_q;

    // kh_071_pop21135_mux(MUX,51)
    assign kh_071_pop21135_mux_s = in_valid_in_0;
    always @(kh_071_pop21135_mux_s or in_kh_071_pop21135_1 or in_kh_071_pop21135_0)
    begin
        unique case (kh_071_pop21135_mux_s)
            1'b0 : kh_071_pop21135_mux_q = in_kh_071_pop21135_1;
            1'b1 : kh_071_pop21135_mux_q = in_kh_071_pop21135_0;
            default : kh_071_pop21135_mux_q = 32'b0;
        endcase
    end

    // out_kh_071_pop21135(GPOUT,68)
    assign out_kh_071_pop21135 = kh_071_pop21135_mux_q;

    // kw_068_pop33112_pop45165_mux(MUX,52)
    assign kw_068_pop33112_pop45165_mux_s = in_valid_in_0;
    always @(kw_068_pop33112_pop45165_mux_s or in_kw_068_pop33112_pop45165_1 or in_kw_068_pop33112_pop45165_0)
    begin
        unique case (kw_068_pop33112_pop45165_mux_s)
            1'b0 : kw_068_pop33112_pop45165_mux_q = in_kw_068_pop33112_pop45165_1;
            1'b1 : kw_068_pop33112_pop45165_mux_q = in_kw_068_pop33112_pop45165_0;
            default : kw_068_pop33112_pop45165_mux_q = 32'b0;
        endcase
    end

    // out_kw_068_pop33112_pop45165(GPOUT,69)
    assign out_kw_068_pop33112_pop45165 = kw_068_pop33112_pop45165_mux_q;

    // kw_068_pop33152_mux(MUX,53)
    assign kw_068_pop33152_mux_s = in_valid_in_0;
    always @(kw_068_pop33152_mux_s or in_kw_068_pop33152_1 or in_kw_068_pop33152_0)
    begin
        unique case (kw_068_pop33152_mux_s)
            1'b0 : kw_068_pop33152_mux_q = in_kw_068_pop33152_1;
            1'b1 : kw_068_pop33152_mux_q = in_kw_068_pop33152_0;
            default : kw_068_pop33152_mux_q = 32'b0;
        endcase
    end

    // out_kw_068_pop33152(GPOUT,70)
    assign out_kw_068_pop33152 = kw_068_pop33152_mux_q;

    // li_073100_pop40168_mux(MUX,54)
    assign li_073100_pop40168_mux_s = in_valid_in_0;
    always @(li_073100_pop40168_mux_s or in_li_073100_pop40168_1 or in_li_073100_pop40168_0)
    begin
        unique case (li_073100_pop40168_mux_s)
            1'b0 : li_073100_pop40168_mux_q = in_li_073100_pop40168_1;
            1'b1 : li_073100_pop40168_mux_q = in_li_073100_pop40168_0;
            default : li_073100_pop40168_mux_q = 32'b0;
        endcase
    end

    // out_li_073100_pop40168(GPOUT,71)
    assign out_li_073100_pop40168 = li_073100_pop40168_mux_q;

    // li_073124_mux(MUX,55)
    assign li_073124_mux_s = in_valid_in_0;
    always @(li_073124_mux_s or in_li_073124_1 or in_li_073124_0)
    begin
        unique case (li_073124_mux_s)
            1'b0 : li_073124_mux_q = in_li_073124_1;
            1'b1 : li_073124_mux_q = in_li_073124_0;
            default : li_073124_mux_q = 32'b0;
        endcase
    end

    // out_li_073124(GPOUT,72)
    assign out_li_073124 = li_073124_mux_q;

    // li_07398_pop22140_mux(MUX,56)
    assign li_07398_pop22140_mux_s = in_valid_in_0;
    always @(li_07398_pop22140_mux_s or in_li_07398_pop22140_1 or in_li_07398_pop22140_0)
    begin
        unique case (li_07398_pop22140_mux_s)
            1'b0 : li_07398_pop22140_mux_q = in_li_07398_pop22140_1;
            1'b1 : li_07398_pop22140_mux_q = in_li_07398_pop22140_0;
            default : li_07398_pop22140_mux_q = 32'b0;
        endcase
    end

    // out_li_07398_pop22140(GPOUT,73)
    assign out_li_07398_pop22140 = li_07398_pop22140_mux_q;

    // li_07399_pop34155_mux(MUX,57)
    assign li_07399_pop34155_mux_s = in_valid_in_0;
    always @(li_07399_pop34155_mux_s or in_li_07399_pop34155_1 or in_li_07399_pop34155_0)
    begin
        unique case (li_07399_pop34155_mux_s)
            1'b0 : li_07399_pop34155_mux_q = in_li_07399_pop34155_1;
            1'b1 : li_07399_pop34155_mux_q = in_li_07399_pop34155_0;
            default : li_07399_pop34155_mux_q = 32'b0;
        endcase
    end

    // out_li_07399_pop34155(GPOUT,74)
    assign out_li_07399_pop34155 = li_07399_pop34155_mux_q;
    ...
    // unnamed_load_input051_mux(MUX,93)
    assign unnamed_load_input051_mux_s = in_valid_in_0;
    always @(unnamed_load_input051_mux_s or in_unnamed_load_input051_1 or in_unnamed_load_input051_0)
    begin
        unique case (unnamed_load_input051_mux_s)
            1'b0 : unnamed_load_input051_mux_q = in_unnamed_load_input051_1;
            1'b1 : unnamed_load_input051_mux_q = in_unnamed_load_input051_0;
            default : unnamed_load_input051_mux_q = 1'b0;
        endcase
    end

    // out_unnamed_load_input051(GPOUT,86)
    assign out_unnamed_load_input051 = unnamed_load_input051_mux_q;
