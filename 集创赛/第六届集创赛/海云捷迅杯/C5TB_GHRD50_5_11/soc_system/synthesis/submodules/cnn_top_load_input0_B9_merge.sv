...
module cnn_top_load_input0_B9_merge (
    ...
    wire [0:0] li_073_mux_s;
    reg [31:0] li_073_mux_q;
    ...
    // out_forked97(GPOUT,11)
    assign out_forked97 = forked97_mux_q;

    // li_073_mux(MUX,10)
    assign li_073_mux_s = in_valid_in_0;
    always @(li_073_mux_s or in_li_073_1 or in_li_073_0)
    begin
        unique case (li_073_mux_s)
            1'b0 : li_073_mux_q = in_li_073_1;
            1'b1 : li_073_mux_q = in_li_073_0;
            default : li_073_mux_q = 32'b0;
        endcase
    end

    // out_li_073(GPOUT,12)
    assign out_li_073 = li_073_mux_q;
