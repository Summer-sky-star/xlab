...
// SystemVerilog created from cnn_top_i_iord_bl_input_ctrl0_unnamed_load_input023_load_input00
// SystemVerilog created on Fri Mar  4 14:17:41 2022


(* altera_attribute = "-name AUTO_SHIFT_REGISTER_RECOGNITION OFF; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 10037; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 15400; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 12020; -name MESSAGE_DISABLE 12030; -name MESSAGE_DISABLE 12010; -name MESSAGE_DISABLE 12110; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 13410; -name MESSAGE_DISABLE 113007; -name MESSAGE_DISABLE 10958" *)
module cnn_top_i_iord_bl_input_ctrl0_unnamed_load_input023_load_input00 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_input_ctrl0_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_input_ctrl0_i_fifovalid;
    assign iord_i_predicate = in_cmp8340;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_input_ctrl0_i_fifodata),
    ...
    assign out_iord_bl_input_ctrl0_o_fifoready = iord_o_fifoready;

    // regfree_osync(GPOUT,13)
    assign out_iord_bl_input_ctrl0_o_fifoalmost_full = iord_o_fifoalmost_full;
