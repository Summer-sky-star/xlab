...
// SystemVerilog created from cnn_top_i_iord_bl_return_load_weight1_unnamed_74_cnn_top0
// SystemVerilog created on Fri Mar  4 14:17:40 2022


(* altera_attribute = "-name AUTO_SHIFT_REGISTER_RECOGNITION OFF; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 10037; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 15400; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 12020; -name MESSAGE_DISABLE 12030; -name MESSAGE_DISABLE 12010; -name MESSAGE_DISABLE 12110; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 13410; -name MESSAGE_DISABLE 113007; -name MESSAGE_DISABLE 10958" *)
module cnn_top_i_iord_bl_return_load_weight1_unnamed_74_cnn_top0 (
    ...
    input wire [0:0] in_unnamed_cnn_top73,
    input wire clock,
    input wire resetn
    );
    ...
    // iord(EXTIFACE,7)
    assign iord_i_fifodata = in_iord_bl_return_load_weight1_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_return_load_weight1_i_fifovalid;
    assign iord_i_predicate = in_unnamed_cnn_top73;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_return_load_weight1_i_fifodata),
    ...
    assign out_iord_bl_return_load_weight1_o_fifoready = iord_o_fifoready;
    ...
    assign out_iord_bl_return_load_weight1_o_fifoalmost_full = iord_o_fifoalmost_full;
