...
// SystemVerilog created from cnn_top_i_iord_bl_weight_ctrl1_unnamed_l0000ght122_load_weight10
...
module cnn_top_i_iord_bl_weight_ctrl1_unnamed_l0000ght122_load_weight10 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_weight_ctrl1_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_weight_ctrl1_i_fifovalid;
    assign iord_i_predicate = in_cmp8238;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_weight_ctrl1_i_fifodata),
    ...
    assign ip_dsdk_adapt_bitselect4_b = iord_o_data[15:8];
    ...
    assign out_iord_bl_weight_ctrl1_o_fifoready = iord_o_fifoready;

    // regfree_osync(GPOUT,13)
    assign out_iord_bl_weight_ctrl1_o_fifoalmost_full = iord_o_fifoalmost_full;
