...
void InputRearrange(int8_t* din, int8_t* dout, const int c, const int h,
    ...
    for(int i = 0; i < UpRound(c, INPUT_EXTEND_SCALE); i++) {
        ...
        for(int j = 1; j < UpRound((h + 2 * pad)*(w + 2 * pad),16); j++) {
                buff1=vld1q_s8(dout_array[0]+idx_fpga_idata);
                buff2=vld1q_s8(dout_array[1]+idx_fpga_idata);
                buff3=vld1q_s8(dout_array[2]+idx_fpga_idata);
                buff4=vld1q_s8(dout_array[3]+idx_fpga_idata);
                buff5=vld1q_s8(dout_array[4]+idx_fpga_idata);
                buff6=vld1q_s8(dout_array[5]+idx_fpga_idata);
                buff7=vld1q_s8(dout_array[6]+idx_fpga_idata);
                buff8=vld1q_s8(dout_array[7]+idx_fpga_idata);
                buff9=vld1q_s8(dout_array[8]+idx_fpga_idata);
                buff10=vld1q_s8(dout_array[9]+idx_fpga_idata);
                buff11=vld1q_s8(dout_array[10]+idx_fpga_idata);
                buff12=vld1q_s8(dout_array[11]+idx_fpga_idata);
                buff13=vld1q_s8(dout_array[12]+idx_fpga_idata);
                buff14=vld1q_s8(dout_array[13]+idx_fpga_idata);
                buff15=vld1q_s8(dout_array[14]+idx_fpga_idata);
                buff16=vld1q_s8(dout_array[15]+idx_fpga_idata);
                vst1q_s8(dout+16*(idx_fpga_idata),buff1);
                vst1q_s8(dout+16*(idx_fpga_idata+1),buff2);
                vst1q_s8(dout+16*(idx_fpga_idata+2),buff3);
                vst1q_s8(dout+16*(idx_fpga_idata+3),buff4);
                vst1q_s8(dout+16*(idx_fpga_idata+4),buff5);
                vst1q_s8(dout+16*(idx_fpga_idata+5),buff6);
                vst1q_s8(dout+16*(idx_fpga_idata+6),buff7);
                vst1q_s8(dout+16*(idx_fpga_idata+7),buff8);
                vst1q_s8(dout+16*(idx_fpga_idata+8),buff9);
                vst1q_s8(dout+16*(idx_fpga_idata+9),buff10);
                vst1q_s8(dout+16*(idx_fpga_idata+10),buff11);
                vst1q_s8(dout+16*(idx_fpga_idata+11),buff12);
                vst1q_s8(dout+16*(idx_fpga_idata+12),buff13);
                vst1q_s8(dout+16*(idx_fpga_idata+13),buff14);
                vst1q_s8(dout+16*(idx_fpga_idata+14),buff15);
                vst1q_s8(dout+16*(idx_fpga_idata+15),buff16);
                idx_fpga_idata+=16;
                } 
        for(int k = (UpRound((h + 2 * pad)*(w + 2 * pad),16)-1)*16;k<(h + 2 * pad)*(w + 2 * pad);k++) {
                buff1=vld1q_lane_s8(((dout_array[0]++)+idx_fpga_idata),buff1,0);
                buff1=vld1q_lane_s8(((dout_array[1]++)+idx_fpga_idata),buff1,1);
                buff1=vld1q_lane_s8(((dout_array[2]++)+idx_fpga_idata),buff1,2);
                buff1=vld1q_lane_s8(((dout_array[3]++)+idx_fpga_idata),buff1,3);
                buff1=vld1q_lane_s8(((dout_array[4]++)+idx_fpga_idata),buff1,4);
                buff1=vld1q_lane_s8(((dout_array[5]++)+idx_fpga_idata),buff1,5);
                buff1=vld1q_lane_s8(((dout_array[6]++)+idx_fpga_idata),buff1,6);
                buff1=vld1q_lane_s8(((dout_array[7]++)+idx_fpga_idata),buff1,7);
                buff1=vld1q_lane_s8(((dout_array[8]++)+idx_fpga_idata),buff1,8);
                buff1=vld1q_lane_s8(((dout_array[9]++)+idx_fpga_idata),buff1,9);
                buff1=vld1q_lane_s8(((dout_array[10]++)+idx_fpga_idata),buff1,10);
                buff1=vld1q_lane_s8(((dout_array[11]++)+idx_fpga_idata),buff1,11);
                buff1=vld1q_lane_s8(((dout_array[12]++)+idx_fpga_idata),buff1,12);
                buff1=vld1q_lane_s8(((dout_array[13]++)+idx_fpga_idata),buff1,13);
                buff1=vld1q_lane_s8(((dout_array[14]++)+idx_fpga_idata),buff1,14);
                buff1=vld1q_lane_s8(((dout_array[15]++)+idx_fpga_idata),buff1,15);
                vst1q_s8(dout+16*(idx_fpga_idata)+idx_fpga_idata2,buff1);
                idx_fpga_idata2+=16;
                } 
